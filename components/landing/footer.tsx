      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl">INVOISKY</span>
            </div>
            <p className="text-gray-400 mb-4">
              AI-powered invoicing solution for freelancers, startups, and SMEs.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-white">Updates</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-white">Support Center</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} INVOISKY. All rights reserved.
          </p>
